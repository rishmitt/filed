...
1. Setup codebase
    ...
    1. clone the code in a directory
       ...
       git clone https://github.com/rishmitt/filed.git
...
3. create the table in audioserver database
     1. in `.env` file add the data as below
            ...
            # example
            # DATABASE_URL="postgresql://rishabh:mittal@localhost:5432/audioserver"
...
1. Clone the repo from github
    `git clone https://github.com/rishsmitt/filed.git`
